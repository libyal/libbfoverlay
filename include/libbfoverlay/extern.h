...
#if !defined( _LIBBFOVERLAY_EXTERN_H )
#define _LIBBFOVERLAY_EXTERN_H

/* To export functions from the libbfoverlay DLL define LIBBFOVERLAY_DLL_EXPORT
 * To import functions from the libbfoverlay DLL define LIBBFOVERLAY_DLL_IMPORT
