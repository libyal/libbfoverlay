...
#if !defined( _LIBBFOVERLAY_LIBCTHREADS_H )
#define _LIBBFOVERLAY_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBBFOVERLAY )
#define HAVE_LIBBFOVERLAY_MULTI_THREAD_SUPPORT
#endif

#if defined( HAVE_LIBBFOVERLAY_MULTI_THREAD_SUPPORT )
...
#endif /* defined( HAVE_LIBBFOVERLAY_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBBFOVERLAY_LIBCTHREADS_H ) */
