 ...
 *
 * Copyright (C) 2020-2020, Joachim Metz <joachim.metz@gmail.com>
 *
...
#if !defined( _LIBBFOVERLAY_LIBCFILE_H )
#define _LIBBFOVERLAY_LIBCFILE_H
...
#endif /* !defined( _LIBBFOVERLAY_LIBCFILE_H ) */
