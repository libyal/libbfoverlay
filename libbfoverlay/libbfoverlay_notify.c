...
{
	static char *function = "libbfoverlay_notify_set_stream";
...
int libbfoverlay_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libbfoverlay_notify_stream_open";
...
int libbfoverlay_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libbfoverlay_notify_stream_close";
