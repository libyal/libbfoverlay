...
#if !defined( _BFOVERLAYTOOLS_GETOPT_H )
#define _BFOVERLAYTOOLS_GETOPT_H
...
typedef struct bfoverlaytools_option bfoverlaytools_option_t;

struct bfoverlaytools_option
{
...
#define bfoverlaytools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t bfoverlaytools_getopt(
                  int argument_count,
...
void bfoverlaytools_getopt_wrapped_fprint(
      FILE *stream,
...
void bfoverlaytools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const bfoverlaytools_option_t *options,
      int number_of_options );

int bfoverlaytools_getopt_get_options_string(
     const bfoverlaytools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _BFOVERLAYTOOLS_GETOPT_H ) */
