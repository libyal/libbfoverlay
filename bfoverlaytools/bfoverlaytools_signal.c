...
void (*bfoverlaytools_signal_signal_handler)( bfoverlaytools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( bfoverlaytools_signal_signal_handler != NULL )
			{
				bfoverlaytools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void bfoverlaytools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int bfoverlaytools_signal_attach(
     void (*signal_handler)( bfoverlaytools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "bfoverlaytools_signal_attach";
...
#if defined( _MSC_VER )
	bfoverlaytools_signal_initialize_memory_debug();
#endif
 ...
 * Returns 1 if successful or -1 on error
 */
int bfoverlaytools_signal_detach(
     libcerror_error_t **error )
{
	...
	bfoverlaytools_signal_signal_handler = NULL;
