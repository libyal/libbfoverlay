...
#include "bfoverlaytools_libbfio.h"
...
#include "bfoverlaytools_libuna.h"
#include "bfoverlaytools_output.h"

/* Initializes output settings
 * Returns 1 if successful or -1 on error
 */
int bfoverlaytools_output_initialize(
     int stdio_mode,
     libcerror_error_t **error )
{
	static char *function = "bfoverlaytools_output_initialize";
 ...
 */
void bfoverlaytools_output_copyright_fprint(
      FILE *stream )
{
	if( stream == NULL )
	{
 ...
 */
void bfoverlaytools_output_version_fprint(
      FILE *stream,
      const char *program )
{
	if( stream == NULL )
 ...
 */
void bfoverlaytools_output_version_detailed_fprint(
      FILE *stream,
      const char *program )
{
	if( stream == NULL )
