...
int mount_file_entry_initialize(
     ...
     size_t name_length,
     libbfoverlay_handle_t *bfoverlay_handle,
     libcerror_error_t **error )
{
	...
	*file_entry = memory_allocate_structure(
	...
	( *file_entry )->bfoverlay_handle = bfoverlay_handle;
     ...
     libcerror_error_t **error )
{
	...
	if( file_entry->bfoverlay_handle != NULL )
	{
     ...
     libcerror_error_t **error )
{
	...
	libbfoverlay_handle_t *bfoverlay_handle = NULL;
     ...
     libcerror_error_t **error )
{
	...
	{
		if( libbfoverlay_handle_get_size(
		     file_entry->bfoverlay_handle,
		     size,
		     error ) != 1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			 "%s: unable to retrieve size from handle.",
			 function );
