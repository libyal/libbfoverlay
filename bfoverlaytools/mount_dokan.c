...
int __stdcall mount_dokan_CreateFile(
               ...
               DWORD share_mode BFOVERLAYTOOLS_ATTRIBUTE_UNUSED,
               DWORD creation_disposition,
               DWORD attribute_flags BFOVERLAYTOOLS_ATTRIBUTE_UNUSED,
               DOKAN_FILE_INFO *file_info )
{
	...
	BFOVERLAYTOOLS_UNREFERENCED_PARAMETER( share_mode )
	BFOVERLAYTOOLS_UNREFERENCED_PARAMETER( attribute_flags )
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context BFOVERLAYTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes BFOVERLAYTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access BFOVERLAYTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options BFOVERLAYTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	BFOVERLAYTOOLS_UNREFERENCED_PARAMETER( security_context )
	BFOVERLAYTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	BFOVERLAYTOOLS_UNREFERENCED_PARAMETER( share_access )
	BFOVERLAYTOOLS_UNREFERENCED_PARAMETER( creation_options )
...
{
	libcerror_error_t *error = NULL;
	static char *function    = "mount_dokan_WriteFile";
	...
	if( number_of_bytes_to_write > (DWORD) INT32_MAX )
	{
		libcerror_error_set(
		 &error,
		 LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
		 LIBCERROR_ARGUMENT_ERROR_VALUE_EXCEEDS_MAXIMUM,
		 "%s: invalid number of bytes to write value exceeds maximum.",
		 function );
	...
	if( number_of_bytes_written == NULL )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
		 LIBCERROR_ARGUMENT_ERROR_INVALID_VALUE,
		 "%s: invalid number of bytes written.",
		 function );
	...
	if( write_count > (size_t) INT32_MAX )
	{
		libcerror_error_set(
		 &error,
		 LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
	...
	*number_of_bytes_written = (DWORD) write_count;
...
int __stdcall mount_dokan_GetFileInformation(
               const wchar_t *path,
               BY_HANDLE_FILE_INFORMATION *file_information,
               DOKAN_FILE_INFO *file_info BFOVERLAYTOOLS_ATTRIBUTE_UNUSED )
#else
