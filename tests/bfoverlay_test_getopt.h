...
#if !defined( _BFOVERLAY_TEST_GETOPT_H )
#define _BFOVERLAY_TEST_GETOPT_H
...
#define bfoverlay_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t bfoverlay_test_getopt(
                  int argument_count,
...
#endif /* !defined( _BFOVERLAY_TEST_GETOPT_H ) */
