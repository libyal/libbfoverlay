...
LIBRARY_TESTS="cow_allocation_table_block cow_file cow_file_header descriptor_file error layer notify range support";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./bfoverlay_test_${TEST_NAME}";
...
run_test_with_input()
{
	...
	local TEST_PROFILE_DIRECTORY=$(get_test_profile_directory "input" "libbfoverlay");
